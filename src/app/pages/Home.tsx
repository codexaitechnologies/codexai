       ...
       <section id="courses" className="py-20">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-slate-500 dark:text-gray-400">Choose your career transformation path</p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <motion.div
              ...
              className="group relative bg-gradient-to-br from-blue-50 dark:from-blue-950/50 to-white dark:to-black border border-blue-200 dark:border-blue-500/30 rounded-2xl p-8 hover:border-blue-500 transition-all hover:shadow-xl hover:shadow-blue-500/20"
            >
              ...
              <div className="flex items-center justify-between">
                <span className="text-blue-500">3+ Projects</span>
                <Link
                  to="/course/java-backend"
                  className="flex items-center gap-2 text-blue-500 group-hover:text-blue-600 dark:group-hover:text-blue-300 transition-colors"
                >
            ...
            <motion.div
              ...
              className="group relative bg-gradient-to-br from-purple-50 dark:from-purple-950/50 to-white dark:to-black border border-purple-200 dark:border-purple-500/30 rounded-2xl p-8 hover:border-purple-500 transition-all hover:shadow-xl hover:shadow-purple-500/20"
            >
              ...
              <div className="flex items-center justify-between">
                <span className="text-purple-500">4+ Projects</span>
                <Link
                  to="/course/aws-cloud"
                  className="flex items-center gap-2 text-purple-500 group-hover:text-purple-600 dark:group-hover:text-purple-300 transition-colors"
                >
                  View Curriculum <ArrowRight className="w-4 h-4" />
                </Link>
              </div>
            ...
            <motion.div
              ...
              className="group relative bg-gradient-to-br from-orange-50 dark:from-orange-950/50 to-white dark:to-black border border-orange-200 dark:border-orange-500/30 rounded-2xl p-8 hover:border-orange-500 transition-all hover:shadow-xl hover:shadow-orange-500/20"
            >
              ...
              <div className="flex items-center justify-between">
                <span className="text-orange-500">5+ Projects</span>
                <Link
                  to="/course/gen-ai"
                  className="flex items-center gap-2 text-orange-500 group-hover:text-orange-600 dark:group-hover:text-orange-300 transition-colors"
                >
                  View Curriculum <ArrowRight className="w-4 h-4" />
                </Link>
              </div>
            ...
            <motion.div
              ...
              className="group relative bg-gradient-to-br from-blue-500/10 via-purple-500/10 to-orange-500/10 border-2 border-blue-500 rounded-2xl p-8 hover:shadow-2xl hover:shadow-blue-500/30 transition-all"
            >
              ...
              <div className="grid grid-cols-2 gap-3 mb-6">
                {["Full Java Backend","AWS Cloud Mastery","Generative AI","System Design","Interview Prep","Career Mentorship"].map((f) => (
                  <div key={f} className="flex items-center gap-2 text-sm text-slate-500 dark:text-gray-400">
              ...
              <div className="flex items-center justify-between">
                <span className="text-blue-500">15+ Projects</span>
                <Link
